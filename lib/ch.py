...
#    Nullspeaker <nhammond129@gmail.com>
...
# Version: 1.3.8
# Description:
#    An event-based library for connecting to one or multiple Chatango rooms,
#    has support for several things including: messaging, message font,
...
#
#    Where a more satisfactory response to all bug reports (which can be made
#    on the issues page) and other statements can be garnered. For things not
#    specific or in direct reference to this library, 'ch.py', a direct
#    response can be filed to the individual persons listed above as
#    'Current Maintainers and Contributors.'
################################################################
